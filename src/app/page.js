        ...
        <div className='bg-[#fff] w-full h-fit mx-auto  mt-10 py-10 rounded-[25px] relative'>
          ...
          <div className='bg-[#faf8ff] w-11/12 mx-auto rounded-lg  my-5 flex items-center justify-around px-2  md:px-6 lg:px-10 py-4'>
            <div className='flex flex-col items-center justify-center space-y-1 '>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#f8a418" className="w-6">
                <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
              </svg>
              <div className='flex flex-col items-center justify-end -space-y-1 h-full'>
                <p className='font-bold text-base'>230</p>
                <p className='font-bold text-sm text-[#7b6f96]'>Score</p>
              </div>
            </div>
            ...
            <div className='flex flex-col items-center justify-center space-y-1'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#96dee4" className="w-6">
              ...
              <div className='flex flex-col items-center justify-end -space-y-1 h-full'>
                ...
                <p className='font-bold text-sm text-[#7b6f96]'>Ranking</p>
              </div>
            </div>
            ...
            <div className='flex flex-col items-center justify-center space-y-1'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ec594d" className="w-6">
                <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM12.75 6a.75.75 0 00-1.5 0v6c0 .414.336.75.75.75h4.5a.75.75 0 000-1.5h-3.75V6z" clipRule="evenodd" />
              </svg>
              <div className='flex flex-col items-center justify-end -space-y-1 h-full'>
                <p className='font-bold text-base'>03 Mins</p>
                <p className='font-bold text-sm text-[#7b6f96]'>Completed</p>
              </div>
            </div>
          </div>
          ...
          <div className='w-full px-5 mt-8 lg:px-20'>
            ...
            <div className='mt-5 flex flex-col space-y-3'>
              <div className='flex items-center justify-start gap-4'>
                <p className='text-lg font-bold text-[#523b90]'>#1</p>
                <div className='text-base flex items-center gap-4'>
                  <img
                    className='rounded-full w-[50px] border-4'
                    src="https://www.faceapp.com/static/img/content/compare/old-example-before@3x.jpg"
                    alt="image"
                  />
                  <div>
                    <p className='font-bold'>Ronald Welch</p>
                    <p className='font-semibold text-[#7b6f96]'>Score: <span className='font-bold text-sm text-[#523b90]'>1203</span></p>
                  </div>
                </div>
              </div>
              <hr />
              ...
              <div className='flex items-center justify-start gap-4 my-2'>
                <p className='text-lg font-bold text-[#523b90]'>#2</p>
                <div className='text-base flex items-center gap-4'>
                  <img
                    className='rounded-full w-[50px] border-4'
                    src="https://www.faceapp.com/static/img/content/compare/old-example-before@3x.jpg"
                  ...
                  <div>
                    ...
                    <p className='font-semibold text-[#7b6f96]'>Score: <span className='font-bold text-sm text-[#523b90]'>1000</span></p>
                  </div>
                </div>
              </div>
              <hr />
              ...
              <div className='flex items-center justify-start gap-4 my-2'>
                <p className='text-lg font-bold text-[#523b90]'>#3</p>
                <div className='text-base flex items-center gap-4'>
                  <img
                    className='rounded-full w-[50px] border-4'
                    src="https://www.faceapp.com/static/img/content/compare/old-example-before@3x.jpg"
              ...
              <div className='flex items-center justify-start gap-4 my-2'>
                <p className='text-lg font-bold text-[#523b90]'>#4</p>
                <div className='text-base flex items-center gap-4'>
                  <img
                    className='rounded-full w-[50px] border-4'
                    src="https://www.faceapp.com/static/img/content/compare/old-example-before@3x.jpg"
              ...
              <div className='flex items-center justify-start gap-4 my-2'>
                <p className='text-lg font-bold text-[#523b90]'>#5</p>
                <div className='text-base flex items-center gap-4'>
                  <img
                    className='rounded-full w-[50px] border-4'
                    src="https://www.faceapp.com/static/img/content/compare/old-example-before@3x.jpg"
              ...
              <div className='flex items-center justify-start gap-4 my-2'>
                <p className='text-lg font-bold text-[#523b90]'>#6</p>
                <div className='text-base flex items-center gap-4'>
                  <img
                    className='rounded-full w-[50px] border-4'
                    src="https://www.faceapp.com/static/img/content/compare/old-example-before@3x.jpg"
