              ...
              {rankingData.map((rank, index) => (
                <>
                  <div className='flex items-center justify-start gap-4'>
                    <p className='text-lg font-bold text-[#523b90]'>#{rank.id}</p>
                    <div className='text-base flex items-center gap-4'>
                      ...
                      <div>
                        ...
                        <p className='font-semibold text-[#7b6f96]'>Score: <span className='font-bold text-sm text-[#523b90]'>{rank.score}</span></p>
                      </div>
                    </div>
                  </div>
                  {(rankingData.length == index) ? null : <hr />}
                </>
              ))}
            </div>
          </div>
